...
const RangeSlider = React.forwardRef(
  (
    ...
    React.useEffect(() => {
      // Обновляем localValues при изменении внешнего пропса value
    ...
    return (
      <SliderPrimitive.Root
        ...
        <SliderPrimitive.Track className="relative h-1 w-full grow overflow-hidden rounded-full bg-primary/20">
          <SliderPrimitive.Range className="relative h-full bg-primary" />
          ...
          <React.Fragment key={index}>
            <div
              ...
              style={{
                ...
                top: `20px`, // Увеличен отступ сверху для меток
                transform: 'translateX(-50%)', // Центрирование меток по оси X
              }}>
